@echo off
REM Event Ticketing System API Tests using HTTPie
...
http --session=auth POST %BASE_URL%/events name="Summer Music Festival" description="An amazing outdoor music festival" date=="2026-12-31T18:00:00" totalTickets:=1000
echo.
